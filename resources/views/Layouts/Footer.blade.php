    ...
    <div class="w-full flex flex-col">
        <div class="w-full flex flex-col p-4 sm:p-0">
            <a href="mailto:contact@yolanmack.com" class="flex sm:justify-center items-center" target="_blank">
                <p class="text-3xl text-white hover:text-gray-600 hover:duration-500 duration-500">Contact@yolanmack.com</p>
            </a>
            <a href="tel:+33664568789" class="flex sm:justify-center items-center" target="_blank">
                <p class="text-3xl text-white hover:text-gray-600 hover:duration-500 duration-500"> 06 64 56 87 89</p>
            </a>
            <a href="https://maps.app.goo.gl/kZuMV7ydYMwrR2AG6" class="flex sm:justify-center items-center" target="_blank">
                <p class="text-3xl text-white hover:text-gray-600 hover:duration-500 duration-500"> Rue nationale, Lacroix Saint Ouen - FRANCE </p>
            </a>
        </div>
