...
@endif
<div class="fond-couleur w-full h-screen flex justify-center items-center">
    <div class="w-1/2 py-16 px-12">
        ...
        @endif
        <h2 class="text-2xl mb-4 text-white">Réservation</h2>
        ...
        <form method="POST" action="/events/store">
            ...
            <div class="grid grid-cols-2 gap-5">
                <input name="familyName" id="familyName" type="text" placeholder="Nom"
                       class="border border-gray-400 py-1 px-2" required>
                <input name="firstName" id="firstName" type="text" placeholder="Prénom"
                       class="border border-gray-400 py-1 px-2" required>
            </div>
            <div class="mt-5 grid grid-cols-2 gap-5">
                <input name="email" id="email" type="email" placeholder="Email" class="border border-gray-400 py-1 px-2"
                       required>
                <input name="phoneNumber" id="phoneNumber" type="text" placeholder="Téléphone"
                       class="border border-gray-400 py-1 px-2" required>
            </div>
            <div class="mt-5">
            ...
            <div class="mt-5">
                <input name="eventLocation" id="eventLocation" type="text" placeholder="Lieu de l'évènement"
            ...
            <div class="mt-5">
                <button class="w-full bg-[#C1E7FA] py-3 text-center text-white" type="submit">Envoyer la reservation
                </button>
            </div>
